 ...
 * @param suite is the ciphersuite 
 * @param mode5869 - controls labelling specifics
 * @param dh - the initial DH shared secret
 * @param dhlen - length of above
 * @param context - the info
 * @param contextlen - length of above
