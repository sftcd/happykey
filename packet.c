...
/*
 * SF - this is a snapshot of OpenSSL's crypto/packet.c that we're using
 * to make a shim version of HPKE.
 */

/*
 * SF - don't want this for our shim 
...
/* SF - things we do need for our shim */
#ifndef ossl_assert
#define ossl_assert 
#endif
#ifndef ERR_raise
#define ERR_raise(__x__,__y__) printf("%s:%s error %d, %d",__FILE__,__LINE__,__x__,__y__)
#endif
#ifndef ossl_quic_vlint_encode_n
#define ossl_quic_vlint_encode_n(data, value, len);
#endif
#ifndef ossl_quic_vlint_encode
#define ossl_quic_vlint_encode(b, v)
#endif
